...
.method private a(JLcom/baidu/android/pushservice/message/h;)[B
    ...
    const-string/jumbo v5, "wrapMsgHead error : "
...
.method public a(I)V
    ...
    invoke-virtual {v1}, Lcom/baidu/android/pushservice/k;->b()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/baidu/android/pushservice/k;->a()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/baidu/android/pushservice/config/ModeConfig;->getHighestVersion()I
    ...
    invoke-static {v1, v2}, Lcom/baidu/android/pushservice/jni/BaiduAppSSOJni;->encryptAES(Ljava/lang/String;I)[B
    ...
    const-string v4, "onSessionOpened, send handshake msg :"
    ...
    invoke-direct {p0, v2, v1}, Lcom/baidu/android/pushservice/message/g;->a(S[B)[B

    move-result-object v1

    new-instance v2, Lcom/baidu/android/pushservice/message/f;

    sget-object v3, Lcom/baidu/android/pushservice/message/i;->b:Lcom/baidu/android/pushservice/message/i;

    invoke-virtual {v3}, Lcom/baidu/android/pushservice/message/i;->a()S

    move-result v3

    invoke-direct {v2, v3}, Lcom/baidu/android/pushservice/message/f;-><init>(S)V

    iput-object v1, v2, Lcom/baidu/android/pushservice/message/f;->c:[B

    iput-boolean v8, v2, Lcom/baidu/android/pushservice/message/f;->d:Z

    const/4 v1, 0x0

    invoke-virtual {v2, v1}, Lcom/baidu/android/pushservice/message/f;->a(Z)V
