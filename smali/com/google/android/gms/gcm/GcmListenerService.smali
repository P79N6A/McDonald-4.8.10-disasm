...
.method private zzo(Landroid/content/Intent;)V
    ...
    invoke-static {v0}, Lcom/google/android/gms/gcm/zza;->zzA(Landroid/os/Bundle;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-static {p0}, Lcom/google/android/gms/gcm/zza;->zzaR(Landroid/content/Context;)Z

    move-result v1

    if-nez v1, :cond_0

    invoke-static {p0}, Lcom/google/android/gms/gcm/zza;->zzaQ(Landroid/content/Context;)Lcom/google/android/gms/gcm/zza;

    move-result-object v1

    invoke-virtual {v1, v0}, Lcom/google/android/gms/gcm/zza;->zzC(Landroid/os/Bundle;)Z

    :goto_0
    return-void

    :cond_0
    invoke-static {v0}, Lcom/google/android/gms/gcm/zza;->zzB(Landroid/os/Bundle;)V
