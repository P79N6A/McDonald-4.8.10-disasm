...
.method private zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzum()Ljava/lang/Class;
    ...
    invoke-static {p3}, Lcom/google/android/gms/common/util/zzp;->zzdu(Ljava/lang/String;)Ljava/lang/String;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzuf()Ljava/util/Map;
    ...
    :cond_2
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzue()I

    move-result v0

    packed-switch v0, :pswitch_data_0

    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzui()Z
    ...
    invoke-static {v2}, Lcom/google/android/gms/common/util/zzc;->zzl([B)Ljava/lang/String;
...
.method protected zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Z
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzue()I
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzuj()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzuk()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzdp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzdo(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzdn(Ljava/lang/String;)Z
...
.method protected zzb(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzum()Ljava/lang/Class;
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzdm(Ljava/lang/String;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzuh()Ljava/util/HashMap;
    ...
    :cond_1
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzug()Ljava/util/HashMap;
...
.method protected abstract zzdm(Ljava/lang/String;)Ljava/lang/Object;
.end method

.method protected abstract zzdn(Ljava/lang/String;)Z
.end method

.method protected zzdo(Ljava/lang/String;)Z
    .locals 2
...
.method public abstract zzuf()Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
            "Ljava/util/Map",
...
.method public zzug()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public zzuh()Ljava/util/HashMap;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
