...
.field private final zzasR:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final zzasY:Landroid/os/Parcel;

.field private final zzasZ:I

.field private zzata:I
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasY:Landroid/os/Parcel;

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasZ:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasR:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasR:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    ...
    :goto_0
    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzata:I
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzut()Ljava/lang/String;
...
.method private static zzU(Ljava/util/Map;)Ljava/util/HashMap;
    .locals 4
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzul()I
...
.method private zza(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/common/util/zzp;->zzdu(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/google/android/gms/common/util/zzc;->zzk([B)Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/google/android/gms/common/util/zzc;->zzl([B)Ljava/lang/String;
...
.method private zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzue()I
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzn(Landroid/os/Bundle;)Ljava/util/HashMap;
...
.method private zza(Ljava/lang/StringBuilder;Ljava/lang/String;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p3}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzuo()Z
...
.method private zza(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzU(Ljava/util/Map;)Ljava/util/HashMap;
    ...
    invoke-static {p3}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzaq(Landroid/os/Parcel;)I
    ...
    invoke-static {v5}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzcj(I)I
...
.method private zzb(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzuj()Z
    ...
    :pswitch_4
    invoke-static {p3, p4}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzA(Landroid/os/Parcel;I)[D
    ...
    :pswitch_5
    invoke-static {p3, p4}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzB(Landroid/os/Parcel;I)[Ljava/math/BigDecimal;
    ...
    :pswitch_7
    invoke-static {p3, p4}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzC(Landroid/os/Parcel;I)[Ljava/lang/String;
    ...
    :pswitch_9
    invoke-static {p3, p4}, Lcom/google/android/gms/common/internal/safeparcel/zza;->zzG(Landroid/os/Parcel;I)[Landroid/os/Parcel;
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzuq()Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/util/zzp;->zzdu(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/util/zzc;->zzk([B)Ljava/lang/String;
...
.method private zzb(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzui()Z
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzud()I
...
.method public static zzn(Landroid/os/Bundle;)Ljava/util/HashMap;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzuv()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasR:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->mClassName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzdq(Ljava/lang/String;)Ljava/util/Map;
...
.method public zzdm(Ljava/lang/String;)Ljava/lang/Object;
    .locals 2
...
.method public zzdn(Ljava/lang/String;)Z
    .locals 2
...
.method public zzuf()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzdq(Ljava/lang/String;)Ljava/util/Map;
...
.method public zzuv()Landroid/os/Parcel;
    .locals 3

    const/4 v2, 0x2

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzata:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasY:Landroid/os/Parcel;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/internal/safeparcel/zzb;->zzar(Landroid/os/Parcel;)I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzatb:I

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasY:Landroid/os/Parcel;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzatb:I

    invoke-static {v0, v1}, Lcom/google/android/gms/common/internal/safeparcel/zzb;->zzJ(Landroid/os/Parcel;I)V

    iput v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzata:I
...
.method zzuw()Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    .locals 4

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasZ:I

    packed-switch v0, :pswitch_data_0

    new-instance v0, Ljava/lang/IllegalStateException;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzasZ:I
