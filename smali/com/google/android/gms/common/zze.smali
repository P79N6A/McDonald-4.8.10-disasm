...
.field static final zzakA:Ljava/util/concurrent/atomic/AtomicBoolean;

.field private static final zzakB:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public static zzaku:Z

.field public static zzakv:Z

.field static zzakw:Z

.field private static zzakx:Ljava/lang/String;

.field private static zzaky:I

.field private static zzakz:Z
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/google/android/gms/common/zze;->zzqZ()I

    move-result v0

    sput v0, Lcom/google/android/gms/common/zze;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzaku:Z

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzakv:Z

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzakw:Z

    const/4 v0, 0x0

    sput-object v0, Lcom/google/android/gms/common/zze;->zzakx:Ljava/lang/String;

    sput v1, Lcom/google/android/gms/common/zze;->zzaky:I

    sput-boolean v1, Lcom/google/android/gms/common/zze;->zzakz:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/zze;->zzakA:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcom/google/android/gms/common/zze;->zzakB:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzaj(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/zzf;->zzaq(Landroid/content/Context;)Lcom/google/android/gms/common/zzf;

    move-result-object v5

    invoke-static {p0}, Lcom/google/android/gms/common/util/zzi;->zzaB(Landroid/content/Context;)Z

    move-result v6

    if-eqz v6, :cond_1

    sget-object v6, Lcom/google/android/gms/common/zzd$zzd;->zzakt:[Lcom/google/android/gms/common/zzd$zza;
    ...
    sget-object v7, Lcom/google/android/gms/common/zzd$zzd;->zzakt:[Lcom/google/android/gms/common/zzd$zza;
    ...
    invoke-static {v0}, Lcom/google/android/gms/common/util/zzl;->zzcx(I)I

    move-result v0

    iget v5, v4, Landroid/content/pm/PackageInfo;->versionCode:I

    invoke-static {v5}, Lcom/google/android/gms/common/util/zzl;->zzcx(I)I
...
.method public static zzag(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/google/android/gms/common/zze;->zzakA:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzaj(Landroid/content/Context;)V
    .locals 6

    sget-object v0, Lcom/google/android/gms/common/zze;->zzakB:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzao(Landroid/content/Context;)V

    sget v0, Lcom/google/android/gms/common/zze;->zzaky:I
    ...
    sget v2, Lcom/google/android/gms/common/zze;->zzaky:I
...
.method public static zzak(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lcom/google/android/gms/common/zze;->zzakw:Z
...
.method public static zzal(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzak(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcom/google/android/gms/common/zze;->zzra()Z
...
.method public static zzam(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v3, v4}, Lcom/google/android/gms/internal/zzpv;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static zzan(Landroid/content/Context;)Z
    ...
    invoke-static {}, Lcom/google/android/gms/common/util/zzs;->zzvd()Z
...
.method private static zzao(Landroid/content/Context;)V
    .locals 1

    sget-boolean v0, Lcom/google/android/gms/common/zze;->zzakz:Z

    if-nez v0, :cond_0

    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzap(Landroid/content/Context;)V
...
.method private static zzap(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/zzy;->zzax(Landroid/content/Context;)I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/google/android/gms/internal/zzpv;->getPackageInfo(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;
    ...
    sget-object v4, Lcom/google/android/gms/common/zzd$zzd;->zzakt:[Lcom/google/android/gms/common/zzd$zza;
    ...
    sput-boolean v0, Lcom/google/android/gms/common/zze;->zzakw:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v6, Lcom/google/android/gms/common/zze;->zzakz:Z
...
.method public static zzc(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lcom/google/android/gms/common/zze;->zzk(Landroid/content/Context;Ljava/lang/String;)Z
...
.method static zzk(Landroid/content/Context;Ljava/lang/String;)Z
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0x15
    .end annotation
    ...
    :cond_1
    invoke-static {p0}, Lcom/google/android/gms/common/zze;->zzan(Landroid/content/Context;)Z
...
.method private static zzqZ()I
    ...
    sget v0, Lcom/google/android/gms/common/internal/zze;->zzaqR:I

    return v0
.end method

.method public static zzra()Z
    .locals 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
