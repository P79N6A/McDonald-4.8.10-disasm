...
.method static serializeHeaders(Lcom/google/api/client/http/HttpHeaders;Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;Ljava/util/logging/Logger;Lcom/google/api/client/http/LowLevelHttpRequest;Ljava/io/Writer;)V
    ...
    .line 952
    invoke-virtual {v15}, Lcom/google/api/client/util/FieldInfo;->getName()Ljava/lang/String;
...
.method public final fromHttpHeaders(Lcom/google/api/client/http/HttpHeaders;)V
    ...
    new-instance v5, Lcom/google/api/client/http/HttpHeaders$HeaderParsingFakeLevelHttpRequest;

    invoke-direct {v5, p0, v1}, Lcom/google/api/client/http/HttpHeaders$HeaderParsingFakeLevelHttpRequest;-><init>(Lcom/google/api/client/http/HttpHeaders;Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;)V

    invoke-static {p1, v2, v3, v4, v5}, Lcom/google/api/client/http/HttpHeaders;->serializeHeaders(Lcom/google/api/client/http/HttpHeaders;Ljava/lang/StringBuilder;Ljava/lang/StringBuilder;Ljava/util/logging/Logger;Lcom/google/api/client/http/LowLevelHttpRequest;)V
...
.method parseHeader(Ljava/lang/String;Ljava/lang/String;Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;)V
    ...
    iget-object v5, v0, Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;->context:Ljava/util/List;

    .line 1131
    .local v5, "context":Ljava/util/List;, "Ljava/util/List<Ljava/lang/reflect/Type;>;"
    move-object/from16 v0, p3

    iget-object v3, v0, Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;->classInfo:Lcom/google/api/client/util/ClassInfo;

    .line 1132
    .local v3, "classInfo":Lcom/google/api/client/util/ClassInfo;
    move-object/from16 v0, p3

    iget-object v2, v0, Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;->arrayValueMap:Lcom/google/api/client/util/ArrayValueMap;

    .line 1133
    .local v2, "arrayValueMap":Lcom/google/api/client/util/ArrayValueMap;
    move-object/from16 v0, p3

    iget-object v8, v0, Lcom/google/api/client/http/HttpHeaders$ParseHeaderState;->logger:Ljava/lang/StringBuilder;

    .line 1135
    .local v8, "logger":Ljava/lang/StringBuilder;
    if-eqz v8, :cond_0
    ...
    invoke-static {v5, v12}, Lcom/google/api/client/util/Data;->resolveWildcardTypeOrTypeVariable(Ljava/util/List;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v11

    .line 1143
    .local v11, "type":Ljava/lang/reflect/Type;
    invoke-static {v11}, Lcom/google/api/client/util/Types;->isArray(Ljava/lang/reflect/Type;)Z
    ...
    .line 1145
    invoke-static {v11}, Lcom/google/api/client/util/Types;->getArrayComponentType(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v12

    invoke-static {v5, v12}, Lcom/google/api/client/util/Types;->getRawArrayComponentType(Ljava/util/List;Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v9

    .line 1147
    .local v9, "rawArrayComponentType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    ...
    invoke-static {v9, v5, v0}, Lcom/google/api/client/http/HttpHeaders;->parseValue(Ljava/lang/reflect/Type;Ljava/util/List;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v13

    invoke-virtual {v2, v12, v9, v13}, Lcom/google/api/client/util/ArrayValueMap;->put(Ljava/lang/reflect/Field;Ljava/lang/Class;Ljava/lang/Object;)V

    .line 1174
    .end local v9    # "rawArrayComponentType":Ljava/lang/Class;, "Ljava/lang/Class<*>;"
    .end local v11    # "type":Ljava/lang/reflect/Type;
    :goto_0
    return-void

    .line 1149
    .restart local v11    # "type":Ljava/lang/reflect/Type;
    :cond_1
    invoke-static {v5, v11}, Lcom/google/api/client/util/Types;->getRawArrayComponentType(Ljava/util/List;Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v12

    const-class v13, Ljava/lang/Iterable;

    invoke-static {v12, v13}, Lcom/google/api/client/util/Types;->isAssignableToOrFrom(Ljava/lang/Class;Ljava/lang/Class;)Z
    ...
    .line 1155
    invoke-static {v11}, Lcom/google/api/client/util/Data;->newCollectionInstance(Ljava/lang/reflect/Type;)Ljava/util/Collection;
    ...
    invoke-virtual {v6, v0, v4}, Lcom/google/api/client/util/FieldInfo;->setValue(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .line 1159
    .local v10, "subFieldType":Ljava/lang/reflect/Type;
    :goto_1
    move-object/from16 v0, p2

    invoke-static {v10, v5, v0}, Lcom/google/api/client/http/HttpHeaders;->parseValue(Ljava/lang/reflect/Type;Ljava/util/List;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 1158
    .end local v10    # "subFieldType":Ljava/lang/reflect/Type;
    :cond_3
    invoke-static {v11}, Lcom/google/api/client/util/Types;->getIterableParameter(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    invoke-static {v11, v5, v0}, Lcom/google/api/client/http/HttpHeaders;->parseValue(Ljava/lang/reflect/Type;Ljava/util/List;Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v12

    move-object/from16 v0, p0

    invoke-virtual {v6, v0, v12}, Lcom/google/api/client/util/FieldInfo;->setValue(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    .end local v11    # "type":Ljava/lang/reflect/Type;
    :cond_5
    invoke-virtual/range {p0 .. p1}, Lcom/google/api/client/http/HttpHeaders;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1168
    .local v7, "listValue":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    if-nez v7, :cond_6

    .line 1169
    new-instance v7, Ljava/util/ArrayList;

    .end local v7    # "listValue":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    invoke-direct {v7}, Ljava/util/ArrayList;-><init>()V

    .line 1170
    .restart local v7    # "listValue":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/String;>;"
    move-object/from16 v0, p0

    move-object/from16 v1, p1

    invoke-virtual {v0, v1, v7}, Lcom/google/api/client/http/HttpHeaders;->set(Ljava/lang/String;Ljava/lang/Object;)Lcom/google/api/client/http/HttpHeaders;
