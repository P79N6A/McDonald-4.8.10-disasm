...
.method public static loadAppSettingsAsync(Landroid/content/Context;Ljava/lang/String;)V
    ...
    sget-object v5, Lcom/facebook/internal/Utility;->fetchedAppSettings:Ljava/util/Map;
    ...
    sget-object v5, Lcom/facebook/internal/Utility;->initialAppSettingsLoadTask:Landroid/os/AsyncTask;
    ...
    invoke-direct {v5, p1, p0, v3}, Lcom/facebook/internal/Utility$1;-><init>(Ljava/lang/String;Landroid/content/Context;Ljava/lang/String;)V

    sput-object v5, Lcom/facebook/internal/Utility;->initialAppSettingsLoadTask:Landroid/os/AsyncTask;

    .line 650
    sget-object v7, Lcom/facebook/internal/Utility;->initialAppSettingsLoadTask:Landroid/os/AsyncTask;

    move-object v5, v6

    check-cast v5, [Ljava/lang/Void;

    instance-of v8, v7, Landroid/os/AsyncTask;

    if-nez v8, :cond_2

    invoke-virtual {v7, v5}, Landroid/os/AsyncTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    invoke-static {v7, v5}, Lcom/newrelic/agent/android/instrumentation/AsyncTaskInstrumentation;->execute(Landroid/os/AsyncTask;[Ljava/lang/Object;)Landroid/os/AsyncTask;

    goto :goto_1

    .line 661
    .restart local v1    # "settingsJSON":Lorg/json/JSONObject;
    .restart local v2    # "settingsJSONString":Ljava/lang/String;
...
.method public static setAppEventExtendedDeviceInfoParameters(Lcom/facebook/model/GraphObject;Landroid/content/Context;)V
    ...
    :goto_1
    invoke-interface {p0, v6, v5}, Lcom/facebook/model/GraphObject;->setProperty(Ljava/lang/String;Ljava/lang/Object;)V
