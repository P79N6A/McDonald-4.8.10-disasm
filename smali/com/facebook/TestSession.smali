...
.method private static declared-synchronized populateTestAccounts(Ljava/util/Collection;Lcom/facebook/model/GraphObject;)V
    ...
    .line 272
    .local v1, "testAccount":Lcom/facebook/TestSession$TestAccount;
    invoke-interface {v1}, Lcom/facebook/TestSession$TestAccount;->getId()Ljava/lang/String;

    move-result-object v3

    const-class v5, Lcom/facebook/model/GraphUser;

    invoke-interface {p1, v3, v5}, Lcom/facebook/model/GraphObject;->getPropertyAs(Ljava/lang/String;Ljava/lang/Class;)Lcom/facebook/model/GraphObject;
    ...
    .line 273
    .local v2, "testUser":Lcom/facebook/model/GraphUser;
    ...
    .end local v0    # "i$":Ljava/util/Iterator;
    .end local v1    # "testAccount":Lcom/facebook/TestSession$TestAccount;
    .end local v2    # "testUser":Lcom/facebook/model/GraphUser;
    :catchall_0
    move-exception v3
...
.method private static declared-synchronized retrieveTestAccountsForAppIfNeeded()V
    ...
    const-string/jumbo v10, "{result=testUsers:$.data.*.id}"
...
.method public final toString()Ljava/lang/String;
    ...
    const-string/jumbo v2, "{TestSession"
