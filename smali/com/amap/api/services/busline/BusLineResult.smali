...
# direct methods
.method private constructor <init>(Lcom/amap/api/services/core/b;Ljava/util/ArrayList;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 29
    invoke-virtual {p1}, Lcom/amap/api/services/core/b;->c()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/amap/api/services/busline/BusLineQuery;

    iput-object v0, p0, Lcom/amap/api/services/busline/BusLineResult;->c:Lcom/amap/api/services/busline/BusLineQuery;

    .line 30
    invoke-virtual {p1}, Lcom/amap/api/services/core/b;->d()I

    move-result v0

    invoke-direct {p0, v0}, Lcom/amap/api/services/busline/BusLineResult;->a(I)I
    ...
    .line 31
    invoke-virtual {p1}, Lcom/amap/api/services/core/b;->f()Ljava/util/List;
    ...
    .line 32
    invoke-virtual {p1}, Lcom/amap/api/services/core/b;->b_()Ljava/util/List;
    ...
    .line 33
    iput-object p2, p0, Lcom/amap/api/services/busline/BusLineResult;->b:Ljava/util/ArrayList;
...
.method static a(Lcom/amap/api/services/core/b;Ljava/util/ArrayList;)Lcom/amap/api/services/busline/BusLineResult;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lcom/amap/api/services/busline/BusLineResult;-><init>(Lcom/amap/api/services/core/b;Ljava/util/ArrayList;)V
