...
.method static constructor <clinit>()V
    ...
    sput-boolean v0, Lcom/amap/api/mapcore/util/ef;->a:Z
...
.method protected constructor <init>(I)V
    ...
    iput-object v0, p0, Lcom/amap/api/mapcore/util/ef;->b:[Ljava/lang/String;

    .line 67
    iput v1, p0, Lcom/amap/api/mapcore/util/ef;->c:I

    .line 68
    iput-boolean v1, p0, Lcom/amap/api/mapcore/util/ef;->d:Z

    .line 69
    iput v1, p0, Lcom/amap/api/mapcore/util/ef;->e:I
...
.method private b(Ljava/lang/String;)V
    ...
    iget v1, p0, Lcom/amap/api/mapcore/util/ef;->c:I
...
.method private d()Ljava/lang/String;
    ...
    :goto_1
    iget v2, p0, Lcom/amap/api/mapcore/util/ef;->c:I

    if-ge v0, v2, :cond_2

    .line 171
    iget-object v2, p0, Lcom/amap/api/mapcore/util/ef;->b:[Ljava/lang/String;
...
.method protected a(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 130
    :try_start_1
    invoke-virtual {v2}, Lcom/amap/api/mapcore/util/fo;->close()V
    :try_end_1
    ...
    .line 82
    :try_start_4
    new-instance v2, Lcom/amap/api/mapcore/util/fo;

    sget-object v0, Lcom/amap/api/mapcore/util/fp;->a:Ljava/nio/charset/Charset;

    invoke-direct {v2, v3, v0}, Lcom/amap/api/mapcore/util/fo;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V
    :try_end_4
    ...
    :goto_3
    :try_start_5
    invoke-virtual {v2}, Lcom/amap/api/mapcore/util/fo;->a()Ljava/lang/String;
    ...
    .line 98
    invoke-direct {p0, v6}, Lcom/amap/api/mapcore/util/ef;->b(Ljava/lang/String;)V

    .line 99
    iget v0, p0, Lcom/amap/api/mapcore/util/ef;->e:I
    :try_end_5
    ...
    :cond_6
    :goto_9
    iget-boolean v0, p0, Lcom/amap/api/mapcore/util/ef;->d:Z

    if-eqz v0, :cond_e

    .line 154
    invoke-direct {p0}, Lcom/amap/api/mapcore/util/ef;->d()Ljava/lang/String;
    ...
    check-cast v0, Lcom/amap/api/mapcore/util/dv;

    .line 105
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/dv;->e()[Ljava/lang/String;

    move-result-object v8

    .line 104
    invoke-static {v8, v6}, Lcom/amap/api/mapcore/util/ef;->a([Ljava/lang/String;Ljava/lang/String;)Z

    move-result v8

    iput-boolean v8, p0, Lcom/amap/api/mapcore/util/ef;->d:Z

    .line 106
    iget-boolean v8, p0, Lcom/amap/api/mapcore/util/ef;->d:Z

    if-eqz v8, :cond_8

    .line 107
    invoke-virtual {p0, v0}, Lcom/amap/api/mapcore/util/ef;->a(Lcom/amap/api/mapcore/util/dv;)V
    ...
    iput v0, p0, Lcom/amap/api/mapcore/util/ef;->e:I
    :try_end_8
    ...
    .line 130
    :try_start_9
    invoke-virtual {v0}, Lcom/amap/api/mapcore/util/fo;->close()V
    :try_end_9
    ...
    invoke-static {v0, v3, v4}, Lcom/amap/api/mapcore/util/eb;->a(Ljava/lang/Throwable;Ljava/lang/String;Ljava/lang/String;)V
...
.method protected a(Landroid/content/Context;)Z
    ...
    sget-boolean v2, Lcom/amap/api/mapcore/util/ef;->a:Z

    if-eqz v2, :cond_2

    .line 39
    sput-boolean v1, Lcom/amap/api/mapcore/util/ef;->a:Z
    ...
    .line 52
    :cond_0
    invoke-virtual {v4}, Lcom/amap/api/mapcore/util/ew;->c()Z
    ...
    invoke-virtual {v4, v1}, Lcom/amap/api/mapcore/util/ew;->c(Z)V
