...
.method public constructor <init>(Lcom/alipay/android/phone/mrpc/core/l;Lcom/alipay/android/phone/mrpc/core/o;)V
    ...
    iput v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->m:I

    iput-boolean v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->n:Z

    iput-boolean v1, p0, Lcom/alipay/android/phone/mrpc/core/q;->o:Z
    ...
    iput-object v0, p0, Lcom/alipay/android/phone/mrpc/core/q;->b:Landroid/content/Context;
...
.method private a(Lorg/apache/http/HttpResponse;ILjava/lang/String;)Lcom/alipay/android/phone/mrpc/core/u;
    ...
    invoke-virtual {v2, v4, v5}, Lcom/alipay/android/phone/mrpc/core/l;->c(J)V
    ...
    invoke-static {v0}, Lcom/alipay/android/phone/mrpc/core/q;->a(Ljava/lang/String;)Ljava/util/HashMap;
    ...
    :goto_0
    invoke-virtual {v2, v1}, Lcom/alipay/android/phone/mrpc/core/p;->b(Ljava/lang/String;)V

    invoke-virtual {v2, v0}, Lcom/alipay/android/phone/mrpc/core/p;->a(Ljava/lang/String;)V

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    invoke-virtual {v2, v0, v1}, Lcom/alipay/android/phone/mrpc/core/p;->a(J)V

    invoke-virtual {v2, v4, v5}, Lcom/alipay/android/phone/mrpc/core/p;->b(J)V
    :try_end_1
...
.method private a(Lorg/apache/http/HttpEntity;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v5}, Lcom/alipay/android/phone/mrpc/core/o;->h()Z
    ...
    invoke-virtual {v4}, Lcom/alipay/android/phone/mrpc/core/o;->f()Lcom/alipay/android/phone/mrpc/core/ac;
    ...
    invoke-static {v1}, Lcom/alipay/android/phone/mrpc/core/r;->a(Ljava/io/Closeable;)V
...
.method private static b(Lorg/apache/http/HttpResponse;)J
    ...
    :try_start_0
    invoke-static {v2}, Lcom/alipay/android/phone/mrpc/core/q;->a([Ljava/lang/String;)J
    :try_end_0
...
.method private d()Lcom/alipay/android/phone/mrpc/core/u;
    ...
    :goto_0
    :try_start_0
    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->b:Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lcom/alipay/android/phone/mrpc/core/o;->f()Lcom/alipay/android/phone/mrpc/core/ac;
    ...
    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/o;->f()Lcom/alipay/android/phone/mrpc/core/ac;
    ...
    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/o;->d()Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Lcom/alipay/android/phone/mrpc/core/q;->c:Lcom/alipay/android/phone/mrpc/core/o;

    invoke-virtual {v7}, Lcom/alipay/android/phone/mrpc/core/o;->a()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->g:Lorg/apache/http/protocol/HttpContext;

    const-string v3, "http.cookie-store"

    iget-object v6, p0, Lcom/alipay/android/phone/mrpc/core/q;->h:Lorg/apache/http/client/CookieStore;

    invoke-interface {v2, v3, v6}, Lorg/apache/http/protocol/HttpContext;->setAttribute(Ljava/lang/String;Ljava/lang/Object;)V

    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->a:Lcom/alipay/android/phone/mrpc/core/l;

    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/l;->a()Lcom/alipay/android/phone/mrpc/core/b;

    move-result-object v2

    sget-object v3, Lcom/alipay/android/phone/mrpc/core/q;->e:Lorg/apache/http/client/HttpRequestRetryHandler;
    ...
    iget-object v3, p0, Lcom/alipay/android/phone/mrpc/core/q;->f:Lorg/apache/http/client/methods/HttpUriRequest;
    ...
    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->k:Lorg/apache/http/HttpHost;
    ...
    iget-object v8, p0, Lcom/alipay/android/phone/mrpc/core/q;->f:Lorg/apache/http/client/methods/HttpUriRequest;

    iget-object v9, p0, Lcom/alipay/android/phone/mrpc/core/q;->g:Lorg/apache/http/protocol/HttpContext;

    instance-of v10, v2, Lorg/apache/http/client/HttpClient;

    if-nez v10, :cond_b

    invoke-virtual {v2, v3, v8, v9}, Lcom/alipay/android/phone/mrpc/core/b;->execute(Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    invoke-virtual {v2, v6, v7}, Lcom/alipay/android/phone/mrpc/core/l;->b(J)V

    iget-object v2, p0, Lcom/alipay/android/phone/mrpc/core/q;->h:Lorg/apache/http/client/CookieStore;
    ...
    iput-object v3, p0, Lcom/alipay/android/phone/mrpc/core/q;->k:Lorg/apache/http/HttpHost;
    ...
    invoke-static {v2, v3, v8, v9}, Lcom/newrelic/agent/android/instrumentation/HttpInstrumentation;->execute(Lorg/apache/http/client/HttpClient;Lorg/apache/http/HttpHost;Lorg/apache/http/HttpRequest;Lorg/apache/http/protocol/HttpContext;)Lorg/apache/http/HttpResponse;
    ...
    :cond_10
    :try_start_4
    invoke-direct {p0, v3, v6, v7}, Lcom/alipay/android/phone/mrpc/core/q;->a(Lorg/apache/http/HttpResponse;ILjava/lang/String;)Lcom/alipay/android/phone/mrpc/core/u;
    ...
    invoke-virtual {v3}, Lcom/alipay/android/phone/mrpc/core/u;->b()[B
    ...
    instance-of v2, v3, Lcom/alipay/android/phone/mrpc/core/p;

    if-eqz v2, :cond_12

    move-object v0, v3

    check-cast v0, Lcom/alipay/android/phone/mrpc/core/p;
    ...
    :try_start_5
    invoke-virtual {v2}, Lcom/alipay/android/phone/mrpc/core/p;->a()Lcom/alipay/android/phone/mrpc/core/HttpUrlHeader;
    ...
    iget v3, p0, Lcom/alipay/android/phone/mrpc/core/q;->m:I
