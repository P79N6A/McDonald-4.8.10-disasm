...
.method constructor <init>(Landroid/content/Context;Lse/emilsjolander/stickylistheaders/StickyListHeadersAdapter;)V
    ...
    .param p2, "delegate"    # Lse/emilsjolander/stickylistheaders/StickyListHeadersAdapter;
...
.method static synthetic access$000(Lse/emilsjolander/stickylistheaders/AdapterWrapper;)Ljava/util/List;
    .locals 1
    .param p0, "x0"    # Lse/emilsjolander/stickylistheaders/AdapterWrapper;
...
.method private configureHeader(Lse/emilsjolander/stickylistheaders/WrapperView;I)Landroid/view/View;
    .locals 3
    .param p1, "wv"    # Lse/emilsjolander/stickylistheaders/WrapperView;
    .param p2, "position"    # I

    .prologue
    .line 127
    iget-object v1, p1, Lse/emilsjolander/stickylistheaders/WrapperView;->mHeader:Landroid/view/View;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Lse/emilsjolander/stickylistheaders/WrapperView;
    ...
    new-instance v2, Lse/emilsjolander/stickylistheaders/WrapperView;

    iget-object v3, p0, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lse/emilsjolander/stickylistheaders/WrapperView;-><init>(Landroid/content/Context;)V

    .line 164
    .end local p2    # "convertView":Landroid/view/View;
    .local v2, "wv":Lse/emilsjolander/stickylistheaders/WrapperView;
    :goto_0
    ...
    iget-object v4, v2, Lse/emilsjolander/stickylistheaders/WrapperView;->mItem:Landroid/view/View;

    invoke-interface {v3, p1, v4, p3}, Lse/emilsjolander/stickylistheaders/StickyListHeadersAdapter;->getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 167
    invoke-direct {p0, v2}, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->recycleHeaderIfExists(Lse/emilsjolander/stickylistheaders/WrapperView;)V
    ...
    instance-of v3, v2, Lse/emilsjolander/stickylistheaders/CheckableWrapperView;

    if-nez v3, :cond_3

    .line 173
    new-instance v2, Lse/emilsjolander/stickylistheaders/CheckableWrapperView;

    .end local v2    # "wv":Lse/emilsjolander/stickylistheaders/WrapperView;
    iget-object v3, p0, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->mContext:Landroid/content/Context;

    invoke-direct {v2, v3}, Lse/emilsjolander/stickylistheaders/CheckableWrapperView;-><init>(Landroid/content/Context;)V

    .line 177
    .restart local v2    # "wv":Lse/emilsjolander/stickylistheaders/WrapperView;
    :cond_0
    :goto_2
    iget-object v3, p0, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->mDivider:Landroid/graphics/drawable/Drawable;

    iget v4, p0, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->mDividerHeight:I

    invoke-virtual {v2, v1, v0, v3, v4}, Lse/emilsjolander/stickylistheaders/WrapperView;->update(Landroid/view/View;Landroid/view/View;Landroid/graphics/drawable/Drawable;I)V
    ...
    .restart local v2    # "wv":Lse/emilsjolander/stickylistheaders/WrapperView;
    :cond_2
    invoke-direct {p0, v2, p1}, Lse/emilsjolander/stickylistheaders/AdapterWrapper;->configureHeader(Lse/emilsjolander/stickylistheaders/WrapperView;I)Landroid/view/View;
...
.method public setOnHeaderClickListener(Lse/emilsjolander/stickylistheaders/AdapterWrapper$OnHeaderClickListener;)V
    .locals 0
    .param p1, "onHeaderClickListener"    # Lse/emilsjolander/stickylistheaders/AdapterWrapper$OnHeaderClickListener;
