...
.method public readCachedSettings()Lorg/json/JSONObject;
    ...
    const-string v8, "Reading cached settings..."
    ...
    iget-object v7, p0, Lio/fabric/sdk/android/services/settings/DefaultCachedSettingsIo;->kit:Lio/fabric/sdk/android/Kit;

    invoke-direct {v6, v7}, Lio/fabric/sdk/android/services/persistence/FileStoreImpl;-><init>(Lio/fabric/sdk/android/Kit;)V
    ...
    :goto_0
    const-string v6, "Error while closing settings cache file."
    ...
    const-string v8, "No cached settings found."
...
.method public writeCachedSettings(JLorg/json/JSONObject;)V
    ...
    :try_start_1
    instance-of v3, p3, Lorg/json/JSONObject;
    ...
    .end local p3    # "settingsJson":Lorg/json/JSONObject;
    :goto_0
    ...
    .restart local p3    # "settingsJson":Lorg/json/JSONObject;
    :cond_1
    :try_start_2
