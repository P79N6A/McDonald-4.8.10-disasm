...
.method private newHttpEngine(Ljava/lang/String;Lcom/squareup/okhttp/internal/http/StreamAllocation;Lcom/squareup/okhttp/internal/http/RetryableSink;Lcom/squareup/okhttp/Response;)Lcom/squareup/okhttp/internal/http/HttpEngine;
    ...
    invoke-virtual {v2, v6}, Lcom/squareup/okhttp/internal/Internal;->getHttpUrlChecked(Ljava/lang/String;)Lcom/squareup/okhttp/HttpUrl;

    move-result-object v13

    .line 340
    .local v13, "httpUrl":Lcom/squareup/okhttp/HttpUrl;
    new-instance v2, Lcom/squareup/okhttp/Request$Builder;

    invoke-direct {v2}, Lcom/squareup/okhttp/Request$Builder;-><init>()V

    .line 341
    invoke-virtual {v2, v13}, Lcom/squareup/okhttp/Request$Builder;->url(Lcom/squareup/okhttp/HttpUrl;)Lcom/squareup/okhttp/Request$Builder;
    ...
    .line 343
    .local v11, "builder":Lcom/squareup/okhttp/Request$Builder;
    ...
    .line 344
    .local v12, "headers":Lcom/squareup/okhttp/Headers;
    const/4 v14, 0x0

    .local v14, "i":I
    invoke-virtual {v12}, Lcom/squareup/okhttp/Headers;->size()I
    ...
    .line 345
    invoke-virtual {v12, v14}, Lcom/squareup/okhttp/Headers;->name(I)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v12, v14}, Lcom/squareup/okhttp/Headers;->value(I)Ljava/lang/String;

    move-result-object v6

    invoke-virtual {v11, v2, v6}, Lcom/squareup/okhttp/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/squareup/okhttp/Request$Builder;
    ...
    .line 335
    .end local v11    # "builder":Lcom/squareup/okhttp/Request$Builder;
    .end local v12    # "headers":Lcom/squareup/okhttp/Headers;
    .end local v13    # "httpUrl":Lcom/squareup/okhttp/HttpUrl;
    .end local v14    # "i":I
    ...
    .line 348
    .restart local v11    # "builder":Lcom/squareup/okhttp/Request$Builder;
    .restart local v12    # "headers":Lcom/squareup/okhttp/Headers;
    .restart local v13    # "httpUrl":Lcom/squareup/okhttp/HttpUrl;
    ...
    invoke-virtual {v11, v2, v6}, Lcom/squareup/okhttp/Request$Builder;->header(Ljava/lang/String;Ljava/lang/String;)Lcom/squareup/okhttp/Request$Builder;

    .line 360
    :goto_2
    const-string v2, "Content-Type"

    invoke-virtual {v12, v2}, Lcom/squareup/okhttp/Headers;->get(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 369
    :cond_3
    instance-of v2, v11, Lcom/squareup/okhttp/Request$Builder;
    ...
    .line 369
    :cond_7
    check-cast v11, Lcom/squareup/okhttp/Request$Builder;

    .end local v11    # "builder":Lcom/squareup/okhttp/Request$Builder;
    invoke-static {v11}, Lcom/newrelic/agent/android/instrumentation/okhttp2/OkHttp2Instrumentation;->build(Lcom/squareup/okhttp/Request$Builder;)Lcom/squareup/okhttp/Request;
